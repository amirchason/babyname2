...
// Load John's v3 comprehensive data
const johnData = JSON.parse(
  fs.readFileSync('/data/data/com.termux/files/home/proj/babyname2/public/data/enriched/john-v3-comprehensive.json', 'utf8')
);
...
<body>
  ...
  <div class="container">
    ...
    <div class="hero">
      ...
      <p class="origin-meaning">🌍 ${johnData.origin} • ${johnData.meaning}</p>
    </div>
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">${johnData.gender === 'male' ? 'Boy' : 'Girl'}</div>
      </div>
    ...
    <div class="section">
      ...
      <p class="section-text">${johnData.culturalSignificance}</p>

      <div class="divider"></div>

      <p class="section-text">${johnData.modernContext}</p>

      <div class="divider"></div>

      <p class="section-text">${johnData.literaryReferences}</p>
    </div>
    ...
    <div class="section">
      ...
      <div class="hist-grid">
${johnData.historicFigures.map(figure => `        <div class="hist-card">
...
${johnData.religiousSignificance.hasSignificance ? `    <div class="section">
      <h2 class="section-title">
      ...
      <div class="religious-box">
        <div class="religious-character">${johnData.religiousSignificance.character}</div>
        <p class="religious-text"><strong>Religions:</strong> ${johnData.religiousSignificance.religions.join(', ')}</p>
        <p class="religious-text">${johnData.religiousSignificance.significance}</p>
        <div class="religious-stories">
          <strong>Key Stories:</strong>
          <ul>
${johnData.religiousSignificance.keyStories.map(story => `            <li>${story}</li>`).join('\n')}
          </ul>
        </div>
        <p class="religious-text" style="margin-top: 12px;"><strong>Spiritual Meaning:</strong> ${johnData.religiousSignificance.spiritualMeaning}</p>
      </div>
    </div>
` : ''}
    <!-- Movies & Shows -->
...
${johnData.moviesAndShows.map(media => `      <div class="pop-card">
...
${johnData.songs.map(song => `      <div class="pop-card">
    ...
    <div class="section">
      <h2 class="section-title">
        ...
        Famous People Named ${johnData.name}
      </h2>
${johnData.famousPeople.map(person => `      <div class="pop-card">
    ...
    <!-- Famous Quotes -->
${johnData.famousQuotes && johnData.famousQuotes.length > 0 ? `    <div class="section">
      <h2 class="section-title">
...
${johnData.famousQuotes.map(q => `      <div class="quote-box">
...
` : ''}
    <!-- Character Quotes -->
${johnData.characterQuotes && johnData.characterQuotes.length > 0 ? `    <div class="section">
      <h2 class="section-title">
...
${johnData.characterQuotes.map(cq => `      <div class="quote-box">
...
` : ''}
    ...
    <div class="section">
      ...
      <p class="section-text"><strong>Personality:</strong> ${johnData.personality}</p>
      <div class="divider"></div>
      <p class="section-text"><strong>Symbolism:</strong> ${johnData.symbolism}</p>

      ${johnData.funFact ? `<div class="fun-fact">
        <span class="fun-fact-text">${johnData.funFact}</span>
      </div>` : ''}
    </div>
...
console.log('🔨 Building John profile with ALL v3 data...');
console.log(`  • Historic Figures: ${johnData.historicFigures.length}`);
console.log(`  • Songs: ${johnData.songs.length}`);
console.log(`  • Movies/Shows: ${johnData.moviesAndShows.length}`);
console.log(`  • Famous People: ${johnData.famousPeople.length}`);
console.log(`  • Nicknames: ${johnData.nicknames.length}`);
...
console.log('\n✅ Complete John profile generated!');
console.log('💾 Saved to: public/john-v3-profile.html');
console.log('   (Original file updated with v3 comprehensive data)');
