/**
 * 🎨 PROFILE TEMPLATE 1 (BASELINE)
 *
 * Generic, reusable name profile template.
 * This is the baseline version - DO NOT modify this file.
 * For new features, use profiletemp2.js or create a new template version.
 *
 * Features:
...
${nameData.famousPeople && nameData.famousPeople.length > 0 ? `    <div class="section">
      <h2 class="section-title">
        ...
        Famous People Named ${nameData.name}
      </h2>
