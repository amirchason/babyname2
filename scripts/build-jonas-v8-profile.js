...
console.log('🚀 Building Jonas V8 Profile...\n');

// Load V8 data
console.log('📂 Loading V8 data...');
const v8Data = JSON.parse(fs.readFileSync('./public/data/enriched/jonas-v8.json', 'utf-8'));
...
// Save
const outputPath = './public/jonas-v8-profile.html';
fs.writeFileSync(outputPath, finalHTML);
console.log(`\n💾 Saved HTML to: ${outputPath}`);

console.log('\n✨ Jonas V8 Profile Complete!');
