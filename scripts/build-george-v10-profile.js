...
console.log('🚀 Building George V10 Profile...\n');

// Load V10 data
console.log('📂 Loading V10 data...');
const v10Data = JSON.parse(fs.readFileSync('./public/data/enriched/george-v10.json', 'utf-8'));
...
// Save
const outputPath = './public/george-v10-profile.html';
fs.writeFileSync(outputPath, finalHTML);
console.log(`\n💾 Saved HTML to: ${outputPath}`);

console.log('\n✨ George V10 Profile Complete!');
