...
<head>
  ...
  <title>${nameCapitalized} - V13 Super Enriched | SoulSeed</title>
...
const outputPath = path.join(__dirname, '..', 'public', 'profiles', 'v13', `${nameLower}-amazing.html`);
...
console.log(`\n✨ V13 AMAZING HTML saved: ${outputPath}\n`);
