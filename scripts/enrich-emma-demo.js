...
async function enrichEmma() {
  console.log('🎨 Enriching Emma with V3.0 data...\n');

  const prompt = `You are an IMDB expert, music database researcher, and baby name specialist. Provide comprehensive, verified information about the name "Emma".
...
1. Include top 3 most famous actors/actresses named Emma (verify IMDB credits)
...
MOVIES/TV SHOWS (Characters Named Emma):
1. Include top 3 most famous movies/TV shows with main characters named Emma
...
CHARACTER QUOTES:
1. Include memorable quotes by characters named Emma
...
Return ONLY valid JSON (no markdown, no code blocks) with this exact structure:
{
  ...
  "literaryReferences": "Notable characters or famous people named Emma",
  ...
  "songs": [
    {
      ...
      "quote": "Memorable lyric from the song mentioning Emma (real lyrics only)"
    }
  ],
  "famousQuotes": [
    {
      "quote": "The actual quote text",
      "person": "Full name of the famous Emma",
  ...
  "moviesAndShows": [
    {
      ...
      "characterName": "Emma [Last Name if applicable]",
  ...
  try {
    ...
    console.log('✅ Enriched Emma successfully!\n');
    console.log(JSON.stringify(enrichment, null, 2));

    // Save to file
    const fs = require('fs');
    const outputPath = '/data/data/com.termux/files/home/proj/babyname2/public/data/enriched/emma.json';
    ...
    fs.writeFileSync(outputPath, JSON.stringify(emmaData, null, 2));
    console.log('\n💾 Saved to: public/data/enriched/emma.json');
